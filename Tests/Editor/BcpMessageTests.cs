...
namespace BCP.Tests
{
    public class BcpMessageTests
    {
        ...
        public void TestStringToBcpMessage()
        {
            ...
            BcpMessage message2 = BcpMessage.CreateFromRawMessage(
            ...
            BcpMessage message3 = BcpMessage.CreateFromRawMessage(
                "testing?param1=int:234&param2=float:45.34&param3"
            );
            ...
            Assert.AreEqual(
                message3.Parameters["param3"].Tag,
                BCP.SimpleJSON.JSONNodeType.NullValue
            );
            Assert.AreEqual(message3.Parameters["param3"].Value, "null");

            BcpMessage message4 = BcpMessage.CreateFromRawMessage(
                "test_json?json%3D%7B%22src%22%3A%22Images%2FSun.png%22%2C%22name%22%3A%22sun1%22%2C%22hOffset%22%3A250%2C%22vOffset%22%3A250%2C%22alignment%22%3A%22center%22%7D"
            );
        ...
        public void TestHelloMessage()
        {
            ...
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "hello?version=1.1&controller_name=Unity%20Test%20Runner&controller_version=1.0"
            );
        ...
        public void TestBallStartMessage()
        {
            BcpMessageController controller = new BcpMessageController();
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "ball_start?player_num=int:1&ball=int:1"
            );
        ...
        public void TestModeStartMessage()
        {
            BcpMessageController controller = new BcpMessageController();
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "mode_start?name=test&priority=int:1"
            );
        ...
        public void TestPlayerTurnStartMessage()
        {
            BcpMessageController controller = new BcpMessageController();
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "player_turn_start?player_num=int:1"
            );
        ...
        public void TestPlayerVariableMessage()
        {
            BcpMessageController controller = new BcpMessageController();
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "player_variable?name=test&player_num=1&value=abc&prev_value=&change="
            );
        ...
        public void TestPlayerScoreMessage()
        {
            BcpMessageController controller = new BcpMessageController();
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "player_variable?name=score&player_num=1&value=int:1234&prev_value=int:0&change=int:1234"
            );
        ...
        public void TestTimerStartedMessage()
        {
            ...
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_started&ticks=int:10&ticks_remaining=int:10"
            );
        ...
        public void TestTimerStoppedMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_stopped&ticks=int:10&ticks_remaining=int:10"
            );
        ...
        public void TestTimerPausedMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_paused&ticks=int:10&ticks_remaining=int:10"
            );
        ...
        public void TestTimerCompletedMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_completed&ticks=int:10&ticks_remaining=int:10"
            );
        ...
        public void TestTimerTickMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_tick&ticks=int:10&ticks_remaining=int:10"
            );
        ...
        public void TestTimerTimeAddedMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_time_added&ticks=int:10&ticks_remaining=int:10&ticks_added=2"
            );
        ...
        public void TestTimerTimeSubtractedMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=timer_test_time_subtracted&ticks=int:10&ticks_remaining=int:10&ticks_subtracted=2"
            );
        ...
        public void TestTiltWarningMessage()
        {
            BcpMessageController controller = new BcpMessageController(true);
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "trigger?name=tilt_warning&warnings=2&warnings_remaining=1"
            );
        ...
        public void TestErrorMessage()
        {
            BcpMessageController controller = new BcpMessageController();
            BcpMessage message = BcpMessage.CreateFromRawMessage(
                "error?message=An%20error%20occurred&command=xxx"
            );
